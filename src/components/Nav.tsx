        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-neutral-800/50">
            <div className="flex flex-col space-y-2 mt-4">
              ...
              {/* Mobile GitHub & Resume Row */}
              <div className="sm:hidden mt-4 pt-4 border-t border-neutral-800/30">
                <div className="flex items-center gap-4">
                  <a
                    href="https://github.com/PryceTharpe"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-neutral-400 hover:text-cyan-300 transition-colors"
                    onClick={closeMobileMenu}
                  >
