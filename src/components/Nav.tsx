  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 flex items-center justify-center text-white font-bold text-lg shadow-md select-none">
          PT
        </div>
        <div className="hidden sm:flex gap-2">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="relative px-4 py-2 rounded-md font-medium text-white/90 hover:text-white transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
            >
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          href="https://github.com/your-github" // TODO: Replace with your actual GitHub
          target="_blank"
        ...
        <a
          href="https://linkedin.com/in/your-linkedin" // TODO: Replace with your actual LinkedIn
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-cyan-300 transition-colors"
          aria-label="LinkedIn"
