  ...
  return (
    <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 hover:border-indigo-500/50 transition-all duration-300 group">
      <div className="flex items-center gap-3 mb-3">
        ...
        <h3 className="font-bold text-indigo-400 group-hover:text-indigo-300 transition-colors">{title}</h3>
      </div>
  ...
  return (
    <main className="bg-neutral-900 text-neutral-100 px-4 sm:px-8 md:px-16 lg:px-32 py-12 min-h-screen">
      ...
      <section className="mb-16">
        ...
        <h1 className="text-5xl font-bold font-mono tracking-wider mb-6 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">
          {project.title}
        </h1>
      ...
      <section className="mb-16">
        ...
        <div className="p-8 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              <h4 className="text-lg font-bold text-indigo-400 mb-4">Key Achievements</h4>
