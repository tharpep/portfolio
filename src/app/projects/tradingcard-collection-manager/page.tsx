...
export const metadata: Metadata = {
  title: "Trading Card Collection Manager – Projects – Pryce Tharpe",
  description: "Full-stack web application for managing trading card collections with multi-user authentication and Supabase integration.",
  alternates: { canonical: "/projects/tradingcard-collection-manager" },
};
...
const project = getProjectBySlug("tradingcard-collection-manager");
const nextProject = getNextProject("tradingcard-collection-manager");
const prevProject = getPreviousProject("tradingcard-collection-manager");

export default function TradingCardCollectionManager() {
            ...
            <ScrollFadeIn>
              <section className="mb-12">
                ...
                <div className="space-y-4 text-neutral-300 leading-relaxed text-base">
                  <p>
                    Full-stack application with React frontend, FastAPI backend, and Supabase for authentication and PostgreSQL database.
                    Row Level Security policies ensure proper data isolation between users.
                  </p>
                  <div className="font-mono text-sm bg-neutral-800/50 border border-neutral-700 rounded-lg p-4 shadow-lg shadow-cyan-500/10">
                    <code className="text-cyan-400">
                      React Frontend → FastAPI Backend → Supabase Auth → PostgreSQL → Row Level Security
                    </code>
                  </div>
                </div>
              </section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 card-lift group">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="font-bold text-white">Authentication System</h3>
                    </div>
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 card-lift group">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="font-bold text-white">Data Isolation</h3>
                    </div>
                    <p className="text-neutral-300 text-sm leading-relaxed">
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 card-lift group">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-3xl group-hover:scale-110 transition-transform">⚙️</span>
                      <h3 className="font-bold text-white">Admin CLI</h3>
                    </div>
                    <p className="text-neutral-300 text-sm leading-relaxed">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
                    <h3 className="text-lg font-bold text-white mb-3">Supabase Integration</h3>
                    <div className="space-y-2 text-neutral-300 text-sm leading-relaxed">
                      <p>Integrated Supabase for PostgreSQL database, authentication, and Row Level Security policies with connection pooling and error handling.</p>
                    </div>
                  </div>
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
                    <h3 className="text-lg font-bold text-white mb-3">FastAPI Backend</h3>
                    <div className="space-y-2 text-neutral-300 text-sm leading-relaxed">
                      <p>Built RESTful API with FastAPI including card CRUD operations, search functionality, favorites system, and user statistics endpoints.</p>
                    </div>
                  </div>
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
                    <h3 className="text-lg font-bold text-white mb-3">Type Safety</h3>
                    <div className="space-y-2 text-neutral-300 text-sm leading-relaxed">
                      <p>Leveraged TypeScript for frontend and Pydantic models for backend ensuring type safety across the full-stack application.</p>
                    </div>
                  </div>
                </div>
              </section>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-neutral-300 text-sm">
                        ...
                        <li>• Responsive UI with modern component libraries</li>
                      </ul>
                    </div>
                  </div>
                </div>
