...
function FeatureCard({ title, description, icon }: { title: string; description: string; icon: string }) {
  return (
    <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 hover:border-emerald-500/50 transition-all duration-300 group">
...
export default function TradingCardCollectionManager() {
  ...
  return (
    <main className="bg-neutral-900 text-neutral-100 px-4 sm:px-8 md:px-16 lg:px-32 py-12 min-h-screen">
      ...
      {/* Core Capabilities */}
      <section className="mb-16">
        <h2 className="text-3xl font-bold font-mono text-emerald-300 mb-8">Core Capabilities</h2>
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <FeatureCard 
            title="Responsive UI"
            description="Designed responsive React frontend with Shadcn UI components, Tailwind CSS styling, and mobile-first design principles."
            icon=""
          />
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold font-mono text-emerald-300 mb-8">Technical Implementation</h2>
        <div className="grid md:grid-cols-2 gap-6">
          <FeatureCard 
          ...
          <FeatureCard 
            ...
            description="Built RESTful API with FastAPI including card CRUD operations, search functionality, favorites system, and user statistics endpoints."
            icon=""
          />
          <FeatureCard 
          ...
          <FeatureCard 
            title="Type Safety"
            description="Leveraged TypeScript for frontend and Pydantic models for backend ensuring type safety across the full-stack application."
            icon=""
          />
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold font-mono text-emerald-300 mb-8">Project Impact & Achievements</h2>
