  ...
  return (
    <main className="bg-neutral-900 text-neutral-100 px-4 sm:px-8 md:px-16 lg:px-32 py-12 min-h-screen">
      ...
      <section className="mb-16">
        ...
        <h1 className="text-5xl font-bold font-mono tracking-wider mb-6 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-400">
          {project.title}
        </h1>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <FeatureCard 
            ...
            description="Implemented three evaluation metrics: Reproducibility (example code validation), Reviewedness (PR review analysis), and Treescore (parent model lineage scoring)."
            icon=""
          />
          <FeatureCard 
            title="Team Collaboration"
            description="Worked in simulated software engineering environment with weekly milestones, client requirements, and team-based development practices."
            icon=""
          />
          <FeatureCard 
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          />
          <FeatureCard 
            title="Treescore Metric"
            description="Computes average net score of immediate parent models in lineage graph, using Hugging Face metadata to trace model ancestry."
            icon=""
          />
        </div>
      </section>
