            ...
            <ScrollFadeIn>
              <section className="mb-12">
                ...
                <div className="space-y-4 text-neutral-300 leading-relaxed text-base">
                  <p>
                    Python-based tools that integrate with Spotify REST API using OAuth 2.0 authentication.
                    Processes music data with Pandas for analytics and provides playlist management capabilities.
                  </p>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 card-lift group">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-3xl group-hover:scale-110 transition-transform">🎵</span>
                      <h3 className="font-bold text-white">Playlist Management</h3>
                    </div>
                    <p className="text-neutral-300 text-sm leading-relaxed">
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 card-lift group">
                    <div className="flex items-center gap-3 mb-3">
                      <span className="text-3xl group-hover:scale-110 transition-transform">🔍</span>
                      <h3 className="font-bold text-white">Music Insights</h3>
                    </div>
                    <p className="text-neutral-300 text-sm leading-relaxed">
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700">
                    ...
                    <div className="space-y-2 text-neutral-300 text-sm leading-relaxed">
                      <p>Python ecosystem tools including Pandas for data analysis, JSON handling for API responses, and data visualization capabilities.</p>
                    </div>
                  </div>
                </div>
              </section>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-neutral-300 text-sm">
                        ...
                        <li>• OAuth 2.0 security implementation</li>
